    ...
    Sim::State: QuantumState<BasisValue = Complex<f64>>,
{
    ...
    #[rustfmt::skip]
    assert!(equal_state_c({sim.next();sim.state()}, &s1, 3, 0.000001));
    #[rustfmt::skip]
    assert!(equal_state_c({sim.next();sim.state()}, &s2, 3, 0.000001));
    #[rustfmt::skip]
    assert!(equal_state_c({sim.next();sim.state()}, &s3, 3, 0.000001));
    #[rustfmt::skip]
    assert!(equal_state_c({sim.next();sim.state()}, &s4, 3, 0.000001));
    #[rustfmt::skip]
    assert!(equal_state_c({sim.next();sim.state()}, &s5, 3, 0.000001));
    #[rustfmt::skip]
    assert!(equal_state_c({sim.next();sim.state()}, &s6, 3, 0.000001));
    #[rustfmt::skip]
    assert!(equal_state_c({sim.next();sim.state()}, &s7, 3, 0.000001));
    ...
    Sim::State: QuantumState<BasisValue = Complex<f64>>,
{
    ...
    sim.next();
    #[rustfmt::skip]
    assert!(equal_state_c({sim.next();sim.state()}, &s1, 4, 0.00001));
    #[rustfmt::skip]
    assert!(equal_state_c({sim.next();sim.state()}, &s2, 4, 0.00001));
}
